...
(function($PS) {
  ...
  var buildStateUpdate = function (v) {
      ...
      throw new Error("Failed pattern match at React.Basic (line 439, column 20 - line 455, column 6): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  "use strict";
  $PS["Sean.App"] = $PS["Sean.App"] || {};
  var exports = $PS["Sean.App"];
  ...
  var app = (function () {
      var update = function (self) {
          return function (v) {
              return new React_Basic.UpdateAndSideEffects({
                  counter: self.state.counter + 1 | 0
              }, function (v1) {
                  return Effect_Console.log("Count: " + Data_Show.show(Data_Show.showInt)(v1.state.counter));
              });
          };
      };
      ...
      var render = function (self) {
          return React_Basic_DOM_Generated.button()({
              onClick: React_Basic_DOM_Events.capture_(send(self)(Increment.value)),
              children: [ React_Basic_DOM.text(self.props.label + (": " + Data_Show.show(Data_Show.showInt)(self.state.counter))) ]
          });
      };
      var initialState = {
          counter: 0
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          var app$prime = Sean_App.app({
              label: "Increment"
          });
          return React_Basic_DOM.render(app$prime)(v.value0)();
      };
      throw new Error("Failed pattern match at Main (line 22, column 3 - line 26, column 24): " + [ v.constructor.name ]);
  };
})(PS);
PS["Main"].main();